...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        {
            public Image connect = global::MissionPlanner.Properties.Resources.disconn50;
            public Image disconnect = global::MissionPlanner.Properties.Resources.conn50;
        ...
        public GCSViews.Supporto SupportoTab;
        ...
        public MainV2()
        {
            ...
            isDebug = false; // utilizzato se true per bypassare il controllo qui sotto e mostrare le funzioni avanzate

            if (Control.ModifierKeys == (Keys.Control | Keys.Shift) || isDebug)
            {
                //Do stuff here
            ...
            try
            {
                ...
                SupportoTab = new GCSViews.Supporto();
                ...
                SupportoTab.Width = MyView.Width;
            }
            ...
            {
                MenuLock.Click -= this.toolStripMenuItem1_Click;
                MenuLock.Text = "";
                MenuLock.Image = Program.Logo;

                MenuLock.Click += MenuCustom_Click;
        ...
        public void MenuCalibrazione_Click(object sender, EventArgs e)
        {
          
                MyView.ShowScreen("Calibrazione");
        ...
        private void MenuConnect_Click(object sender, EventArgs e)
        {
            ...
            if (comPort.BaseStream.IsOpen)
            {
                ...
                this.MenuConnect.Image = global::MissionPlanner.Properties.Resources.conn50;
            }
            else
            {
        ...
        private void xmlconfig(bool write)
        {
            ...
            if (write || !File.Exists(Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar + @"config.xml"))
            {
                try
                {
                   Console.Write(Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar + @"config.xml");
        ...
        private void MainV2_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "Flytop Manager - licenziato a " + MissionPlanner.Properties.Settings.Default.owner;
            ...
            MyView.AddScreen(new MainSwitcher.Screen("Supporto", new GCSViews.Supporto(), false));
            MyView.AddScreen(new MainSwitcher.Screen("Calibrazione", new GCSViews.Calibrazione(),false));
           ...
           return task.ContinueWith(t =>
               {
                   if (t.IsFaulted)
                   {
                      ...
                      // throw t.Exception.InnerException;
                       return "failed log login on flytop.it";
...
private static string ReadStreamFromResponse(WebResponse response)
{
    ...
    using (StreamReader sr = new StreamReader(responseStream))
    {
        ...
        var jsonObject = serializer.DeserializeObject(strContent);
        if (jsonObject.Equals("QUIT"))
        {
            Console.Write("CIAO");
            Program.chiudapp();
            //Dispatcher UserDispatcher = Dispatcher.CurrentDispatcher;
            //UserDispatcher.Invoke(closenow); 
        ...
        void myTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            {
                //do pic
                ///MessageBox.Show("Grazie per aver provato Flytop Manager! \nPer informazioni www.flytop.it");
                ///
                this.BeginInvoke(new MethodInvoker(delegate
    {
        ...
        {
            string message = "Grazie per aver provato Flytop Manager! \nPer informazioni www.flytop.it";
            string caption = "Demo scaduta";


            timeout timeoutform = new timeout();
            timeoutform.Text = caption;

            timeoutform.TopMost = true;

            // Displays the MessageBox.

            timeoutform.ShowDialog(this);

            if (timeoutform.DialogResult == DialogResult.OK)
            {
        ...
        private void MenuHelp_Click(object sender, EventArgs e)
        {
           // MyView.ShowScreen("Help");
            MyView.ShowScreen("Supporto");
            
           // System.Diagnostics.Process.Start("http://www.flytop.it/supporto-tecnico");
